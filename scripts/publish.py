...
if __name__ == "__main__":
    """
    Run this directly to test publishing:
      python publish.py
    """
    logger = setup_logging()
    load_env()
    ...
    latest_mp3 = mp3_files[-1]
    logger.info(f"Publishing latest episode: {latest_mp3.name}")

    feed_url = publish_episode(latest_mp3, config, logger)
